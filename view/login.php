					...
					<div class="col-md-6 col-sm-6 sign-in">
						...
						<form class="register-form outer-top-xs" role="form" action="" method="post">
							<div class="form-group">
								...
								<input type="text/css" class="form-control unicase-form-control text-input" id="username" name="username" >
							</div>
							<div class="form-group">
								<label class="info-title" for="exampleInputPassword1">Password <span>*</span></label>
								<input type="text/css" class="form-control unicase-form-control text-input" id="password" name="password" >
							</div>
